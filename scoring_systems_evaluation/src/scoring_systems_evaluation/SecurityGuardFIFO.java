...
public class SecurityGuardFIFO {

	private String id;
	
	public SecurityGuardFIFO(String id) {
		this.id = id;
	}
	...
	public void step() {
		...
		// import all FIFO vulnerabilities for review as Java Objects
		Context<Object> context = ContextUtils.getContext(this);
		
		Stream<Object> s = context.getObjectsAsStream(VulnerabilityFIFO.class);
