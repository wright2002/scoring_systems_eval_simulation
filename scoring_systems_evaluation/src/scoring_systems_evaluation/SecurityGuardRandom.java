...
public class SecurityGuardRandom {

	private String id;
	
	public SecurityGuardRandom(String id) {
		this.id = id;
	}
	...
	public void step() {
		...
		// import all RANDOM vulnerabilities for review as Java Objects
		Context<Object> context = ContextUtils.getContext(this);
		
		Stream<Object> s = context.getObjectsAsStream(VulnerabilityRandom.class);
