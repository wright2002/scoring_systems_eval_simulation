...
public class SecurityGuardMarist {

	private String id;
	
	public SecurityGuardMarist(String id) {
		this.id = id;
	}
	...
	public void step() {
		...
		// import all MARIST vulnerabilities for review as Java Objects
		Context<Object> context = ContextUtils.getContext(this);
		
		Stream<Object> s = context.getObjectsAsStream(VulnerabilityMarist.class);
