...
public class SecurityGuardEPSS {

	private String id;
	
	public SecurityGuardEPSS(String id) {
		this.id = id;
	}
	...
	public void step() {
		...
		// import all EPSS vulnerabilities for review as Java Objects
		Context<Object> context = ContextUtils.getContext(this);
		
		Stream<Object> s = context.getObjectsAsStream(VulnerabilityEPSS.class);
