...
public class SecurityGuardLIFO {

	private String id;
	
	public SecurityGuardLIFO(String id) {
		this.id = id;
	}
	...
	public void step() {
		...
		// import all LIFO vulnerabilities for review as Java Objects
		Context<Object> context = ContextUtils.getContext(this);
		
		Stream<Object> s = context.getObjectsAsStream(VulnerabilityLIFO.class);
